                                    ...
                                    child: PortalSidebar(
                                      items: [
                                        ...
                                        PortalNavItem(
                                          ...
                                          isActive:
                                              _desktopSection ==
                                              _AdminDesktopSection.analytics,
                                          onTap: _openAnalytics,
                                        ),
                                        PortalNavItem(
                                          icon: Icons.rate_review_outlined,
  ...
  Widget _buildDesktopSection({
    ...
    return IndexedStack(
      ...
      children: sections.map((section) {
        final shouldBuild = section == _AdminDesktopSection.dashboard ||
