...
class _FeedbackManagementScreenState extends State<FeedbackManagementScreen> {
  ...
  List<String> _officeOptions(
    _FeedbackContext context,
    FeedbackAvailableFilters availableFilters,
  ) {
    if (!_isSuperAdmin(context.user)) {
  ...
  List<String> _barangayOptions(FeedbackAvailableFilters availableFilters) {
    return _options(
      [
        if (_selectedBarangay != 'All Barangays') _selectedBarangay,
        ...availableFilters.barangays,
      ],
      'All Barangays',
        ...
        return RefreshIndicator(
          ...
          child: FutureBuilder<_FeedbackPayload>(
            ...
            builder: (context, snapshot) {
              ...
              final availableFilters = payload.summary.availableFilters;
              final officeOptions = _officeOptions(
                payload.context,
                availableFilters,
              );
              final barangayOptions = _barangayOptions(availableFilters);
...
class _FeedbackContext {
  const _FeedbackContext({required this.user});
